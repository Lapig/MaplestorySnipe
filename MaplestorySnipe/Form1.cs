...
namespace MaplestorySnipe
{
    public partial class Form1 : Form
    {
        ...
        public int getPrice()
        {
            IntPtr Base = GameProcess.MainModule.BaseAddress + 0x1673874;
        ...
        {
            IntPtr Base = GameProcess.MainModule.BaseAddress + 0x1671218;
            IntPtr base1 = IntPtr.Add((IntPtr)vam.ReadInt32(Base), 0x20);
        ...
        private void flyingMountSpeedThread()
        {
            while (!stopFly)
            {
                ...
                local.setFlyingMountSpeed((float)0f);
            }
        }
        ...
        private void btnStopFly_Click(object sender, EventArgs e)
        {
            stopFly = true;
        }
        #endregion
